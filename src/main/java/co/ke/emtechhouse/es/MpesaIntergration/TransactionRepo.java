...
//    List<SuccessfullyTransactions> findByGivingId(Long givingId);
  ...
  @Transactional
    ...
    @Transactional
    @Query(nativeQuery = true,value = "SELECT * FROM `transaction` where member_number=:memberNumber  AND t.result_code = 0")
